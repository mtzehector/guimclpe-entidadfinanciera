...
@Provider
public class ConciliacionService extends ServiceDefinition<ConciliacionRequest, Boolean> {
    ...
    @Override
    public Message<Boolean> execute(Message<ConciliacionRequest> request) throws BusinessException {
