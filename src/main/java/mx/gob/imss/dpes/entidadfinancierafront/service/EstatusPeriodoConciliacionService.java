...
@Provider
public class EstatusPeriodoConciliacionService extends ServiceDefinition<PageRequestModelConciliacion, Boolean> {
    ...
    @Override
    public Message<Boolean> execute(Message<PageRequestModelConciliacion> request) throws BusinessException {
